...
const CACHE = 'wiktoros-v14';
const ASSETS = [
  './', './index.html', './tasks.html', './calendar.html', './cal-config.js', './notes.html', './timer.html', './lift.html', './finances.html', './metrics.html', './assets.html', './ideas.html',
  './grid.js', './grid.css', './pwa.js', './sync-config.js', './sync.js', './import.js', './brief.json', './vendor/pdf.min.js', './vendor/pdf.worker.min.js', './vendor/xlsx.full.min.js', './manifest.json',
